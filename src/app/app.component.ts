...
export class MyApp {
  ...
  constructor(public platform: Platform, public statusBar: StatusBar, public splashScreen: SplashScreen) {
    ...
    this.pages = [
      ...
      {title: 'SQlite', icon:'document', component: SqLitePage},
      {title: 'AddPage', icon:'document', component: AddDataPage},
      {title: 'EditePage', icon:'document', component: EditDataPage},
      {title: 'Sliding', icon:'document', component: Page4Page}
    ];
